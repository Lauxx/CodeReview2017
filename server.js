...
mongoose.connect('mongodb://localhost/codeReview');//Mongoose = ORM (Object Relational Mapper) - connectivity point to database. Run in terminal - sudo mongod; sets up connection to database
